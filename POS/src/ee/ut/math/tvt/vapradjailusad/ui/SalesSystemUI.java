package ee.ut.math.tvt.vapradjailusad.ui;
...
import ee.ut.math.tvt.vapradjailusad.ui.tabs.PurchaseTab;
import ee.ut.math.tvt.vapradjailusad.ui.tabs.StockTab;
...
public class SalesSystemUI extends JFrame {
  ...
  public SalesSystemUI(SalesDomainController domainController) {
    ...
    stockTab = new StockTab(this, model, domainController);
